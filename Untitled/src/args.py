...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        default=True,
        help="Plot training loss over epochs (use --no-plot-loss to disable)",
    )
    parser.add_argument(
        "--plot-reconstruction",
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Plot input vs. reconstruction grid after training",
    )
    parser.add_argument(
        "--plot-markov",
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Plot Markov chain samples from the trained model",
    )
